...
func TestSearch_Limit(t *testing.T) {
	...
	if err := runSearch(app, "test", "eng", false, "", "", "", "", 20, 0, "", "", true, &buf); err != nil {
...
func TestSearch_SinceModifier(t *testing.T) {
	...
	app := &appContext{api: fake, outputMode: "ai", userID: "u1", previewLen: 140}
	var buf bytes.Buffer
	if err := runSearch(app, "test", "eng", false, "", "", "", "", 0, 0, "2026-07-01", "", true, &buf); err != nil {
...
func TestSearch_RendersHits(t *testing.T) {
	...
	var buf bytes.Buffer
	if err := runSearch(app, "deploy", "eng", false, "", "", "", "", 0, 0, "", "", true, &buf); err != nil {
